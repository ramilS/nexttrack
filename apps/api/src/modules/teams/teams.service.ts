...
export class TeamsService {
  private readonly logger = new AppLogger(TeamsService.name);
  ...
  async remove(projectId: string, teamId: string): Promise<void> {
    ...
    this.logger.log('Team deleted', { teamId, projectId });
  }
  ...
  async addMembers(
    ...
    this.logger.log('Team members added', {
      teamId,
      projectId,
      memberIds: newUserIds,
    });
