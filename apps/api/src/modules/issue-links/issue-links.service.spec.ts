...
describe('IssueLinksService', () => {
  ...
  beforeEach(async () => {
    ...
    linksRepo = {
      ...
      findDependsOnTargets: jest.fn().mockResolvedValue([]),
    };
  ...
  describe('create', () => {
    ...
    it('should detect dependency cycles for IS_BLOCKED_BY', async () => {
      ...
      // Cycle BFS from sourceIssueId (target of the new DEPENDS_ON edge) finds sourceIssueId itself.
      linksRepo.findDependsOnTargets.mockResolvedValueOnce([sourceIssueId]);
