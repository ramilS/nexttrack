...
export class DashboardsService {
  private readonly logger = new AppLogger(DashboardsService.name);
  ...
  async update(
    ...
    this.logger.log('Updating dashboard', {
      dashboardId,
  ...
  async addWidget(
    ...
    this.logger.log('Dashboard widget added', {
      dashboardId,
      widgetId: widget.id,
      type: dto.type,
    });
  ...
  async updateWidget(
    ...
    this.logger.log('Updating dashboard widget', {
      dashboardId,
      widgetId,
      fields: Object.keys(dto),
    });
  ...
  async removeWidget(
    ...
    this.logger.log('Dashboard widget removed', { dashboardId, widgetId });
  }
