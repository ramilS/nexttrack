...
export class KnowledgeBaseService {
  ...
  async publish(projectId: string, articleId: string): Promise<Article> {
    ...
    return this.repo.setPublishedAt(articleId, new Date());
  }
  ...
  async archive(projectId: string, articleId: string): Promise<Article> {
    ...
    return this.repo.setArchivedAt(articleId, new Date());
  }
  ...
  async addComment(
    ...
    return this.repo.createComment(articleId, userId, dto.body);
  }
  ...
  async updateComment(
    ...
    return this.repo.updateComment(commentId, dto.body);
  }
