...
import { Settings, Tags, Columns3, Package, Users, GitBranch, Users2, UserCog, Zap, Webhook, Plug, Sparkles } from 'lucide-react';
...
const SETTINGS_NAV = [
  ...
  { label: 'AI Docs', href: '/ai-docs', icon: Sparkles },
];
