...
function WatchedIssuesWidget({ widget, dashboardId }: WidgetProps) {
  ...
  if (items.length === 0) {
    return <p className="text-xs text-muted-foreground text-center py-4">No watched issues.</p>;
  }
...
export default WatchedIssuesWidget;
