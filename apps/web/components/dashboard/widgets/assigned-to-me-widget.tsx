...
function AssignedToMeWidget({ widget, dashboardId }: WidgetProps) {
  ...
  if (items.length === 0) {
    return <p className="text-xs text-muted-foreground text-center py-4">No issues assigned to you.</p>;
  }
