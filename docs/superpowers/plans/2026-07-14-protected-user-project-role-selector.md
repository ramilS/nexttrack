...
- [ ] **Step 2: Run the test to verify it fails for the missing field**
...
- [ ] **Step 3: Add the response field and batched computation**
...
- [ ] **Step 4: Commit plan completion markers**
